...
namespace csharp
{
    ...
    public class Student : Person
    {
        ...
        public Student(String name, int age, String npm) : base(name, age) {
            this.npm = npm;
        }

        public Student(String name, int age, String npm, float nilaiPenguji1, float nilaiPenguji2, float nilaiPembimbing): base(name, age) {
            this.npm = npm;
